                      ...
                      <td class="text-center">
                        <div class="cms-action-buttons">
                          <?php if ($actions): ?>
                            ...
                            <?php endforeach; ?>
                          <?php else: ?>
                            <a class="btn btn-sm btn-light" href="#" data-action="edit" data-id="<?php echo cms_h((string) $row['__record_id']); ?>"><i class="fa-solid fa-pen"></i></a>
                            <a class="btn btn-sm btn-light" href="#" data-action="copy" data-id="<?php echo cms_h((string) $row['__record_id']); ?>"><i class="fa-solid fa-copy"></i></a>
                            <a class="btn btn-sm btn-light" href="#" data-action="delete" data-id="<?php echo cms_h((string) $row['__record_id']); ?>"><i class="fa-solid fa-trash"></i></a>
                            <a class="btn btn-sm btn-light" href="#" data-action="view" data-id="<?php echo cms_h((string) $row['__record_id']); ?>"><i class="fa-solid fa-eye"></i></a>
                          <?php endif; ?>
                        </div>
                      </td>
                    </tr>
