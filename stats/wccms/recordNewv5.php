                  ...
                  <div class="row g-4">
                    <?php foreach ($tabFields as $field): ?>
                      ...
                      <?php if ($inputType === 'radio'): ?>
                        <?php
                          $options = cms_form_field_options($pdo, (int) $field['id']);
                          if (!$options) {
                            $options = cms_run_sourcesql($pdo, (string) $sourceSql);
                          }
                        ?>
                      ...
                      <?php elseif ($inputType === 'textarea'): ?>
                        ...
                        <?php elseif ($inputType === 'select'): ?>
                          <?php $options = ($fieldTypeId === 16) ? cms_form_field_options($pdo, (int) $field['id']) : cms_run_sourcesql($pdo, (string) $sourceSql); ?>
                          <?php $widthClass = cms_field_width_class($field['class'] ?? ''); ?>
